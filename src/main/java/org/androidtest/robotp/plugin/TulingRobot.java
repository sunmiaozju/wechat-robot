...
public class TulingRobot {
	...
	// private static final String APIKEY = "2d7dcaee7db94f7e980b820e84c1d3a0";//
	// 这里是我申请的图灵机器人API接口，每天只能5000次调用，建议自己去申请一个，免费的:)
	private static final String APIKEY = "c576e74de50f4480b72e3856d05c7e56";// 这里是我申请的图灵机器人API接口，每天只能5000次调用，建议自己去申请一个，免费的:)
	...
	public static String chat(String nickName, String text) {
		...
		try {
			...
			if (obj.getString("code").equals("100000")) {
				...
				result = "今天聊天太嗨了，条数超过5000条，明天再聊吧。@" + nickName + " 今天你打卡了吗？？\n--------------------\n需要\"菜单\"请回复菜单";
			} else {
