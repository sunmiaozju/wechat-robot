...
public class Constant {
	 ...
	 * 时间处理
	 */
	public final static SimpleDateFormat SIMPLE_DATE_FORMAT_FILE = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss");
	public final static SimpleDateFormat SIMPLE_DAY_FORMAT_FILE = new SimpleDateFormat("yyyy-MM-dd");
	public final static SimpleDateFormat SIMPLE_DATE_FORMAT_LOG = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	...
	public static final String DEFAULT_ADMIN = "Coulson";
