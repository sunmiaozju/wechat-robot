...
public class Config {
	...
	public static void initGroupAndAdmin() {
		Group group = new Group("leetcode刷题群", Constant.DEFAULT_ADMIN);// 新建群信息
		group.addAction(ActionFactory.createMenuAction());// 配置该群有菜单功能
		group.addAction(ActionFactory.createGroupRuleAction(group.getGroupNickName(), new File(
				System.getProperty("user.home") + File.separator + "Desktop" + File.separator + "彭于晏已退出群聊.jpg")));// 配置该群有规则提醒功能
		...
		whiteList.put("Vince蔡培培", new File(System.getProperty("user.home") + File.separator + "Desktop" + File.separator
				+ "DAILY CHECK LIST @Vince蔡培培.xlsx"));
		whiteList.put("王快乐。", new File(System.getProperty("user.home") + File.separator + "Desktop" + File.separator
				+ "DAILY CHECK LIST @王快乐.xlsx"));
		// whiteList.put("张荆钗", new File(System.getProperty("user.home")
		// + File.separator + "Desktop" + File.separator
		// + "2019个人检视清单@张荆钗.xlsx"));
		whiteList.put("shine", new File(System.getProperty("user.home") + File.separator + "Desktop" + File.separator
				+ "DAILY CHECK LIST @shine.xlsx"));
		group.addAction(ActionFactory.createDailySelfReflectionAction(whiteList, true));// 配置该群有每日反思打卡功能，需要配置反思人及对应的反思excel文件地址
		...
		group2.addAction(ActionFactory.createGroupRuleAction(group2.getGroupNickName(), new File(
				System.getProperty("user.home") + File.separator + "Desktop" + File.separator + "运动or2000.jpg")));// 配置该群有规则提醒功能
		...
		group2.addAction(ActionFactory.createLastWeeklyReportClockInAction(2, 1));// 配置该群有周报功能，周报功能会统计并播报运动打卡和每日步数数据
		...
		group3.addAction(ActionFactory.createGroupRuleAction(group3.getGroupNickName(), new File(
				System.getProperty("user.home") + File.separator + "Desktop" + File.separator + "视睿供应链运动family.jpg")));// 配置该群有规则提醒功能
		group3.addAction(ActionFactory.createWeeklyReportClockInAction(2, 2, 1));// 配置该群有周报功能，周报功能会统计并播报运动打卡和每日步数数据
		group3.addAction(ActionFactory.createLastWeeklyReportClockInAction(2, 2, 1));// 配置该群有周报功能，周报功能会统计并播报运动打卡和每日步数数据
		...
		group4.addAction(ActionFactory.createGroupRuleAction(group4.getGroupNickName(),
				new File(System.getProperty("user.home") + File.separator + "Desktop" + File.separator + "运动基金群.jpg")));// 配置该群有规则提醒功能
		...
		// 配置该群有每日步数功能
		group4.addAction(ActionFactory.createLastWeeklyReportClockInAction(-1, 1));// 配置该群有周报功能，周报功能会统计并播报运动打卡和每日步数数据
		...
		group5.addAction(ActionFactory.createGroupRuleAction(group5.getGroupNickName(), new File(
				System.getProperty("user.home") + File.separator + "Desktop" + File.separator + "视睿供应链运动family.jpg")));// 配置该群有规则提醒功能
		group5.addAction(ActionFactory.createWeeklySportClockIn(2));// 配置该群有运动打卡功能，要求一周1次打卡
		// 配置该群有每日步数功能
		group5.addAction(ActionFactory.createLastWeeklyReportClockInAction(-1, 2));// 配置该群有周报功能，周报功能会统计并播报运动打卡和每日步数数据
		...
		group6.addAction(ActionFactory.createGroupRuleAction(group6.getGroupNickName(), new File(
				System.getProperty("user.home") + File.separator + "Desktop" + File.separator + "策采Family运动群.jpg")));// 配置该群有规则提醒功能
		...
		group6.addAction(ActionFactory.createLastWeeklyReportClockInAction(-1, 2));// 配置该群有周报功能，周报功能会统计并播报运动打卡和每日步数数据
		...
		group7.addAction(
				ActionFactory.createGroupRuleAction(group7.getGroupNickName(), new File(System.getProperty("user.home")
						+ File.separator + "Desktop" + File.separator + "【内】供服family运动打卡群.jpg")));//
		// 配置该群有规则提醒功能
		...
		group7.addAction(ActionFactory.createLastWeeklyReportClockInAction(-1, 2));// 配置该群有周报功能，周报功能会统计并播报运动打卡和每日步数数据
