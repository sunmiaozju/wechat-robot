...
public class MessageTools {
	...
	public static boolean sendGroupFileMsgByNickName(String groupNickName, String filePath) {
		if (groupNickName != null) {
			String toUserName = WechatTools.getGroupNameByGroupNickName(groupNickName);
			if (toUserName != null) {
	...
	public static boolean sendGroupMsgByNickName(String text, String nickName) {
		if (nickName != null) {
			String toUserName = WechatTools.getGroupNameByGroupNickName(nickName);
			if (toUserName != null) {
				webWxSendMsg(1, text, toUserName);
				return true;
			}
		}
		// LogUtil.MSG.error("sendGroupMsgByNickName:
		// text:"+text+",groupnickname:"+nickName+",return false");
		return false;
	...
	public static boolean sendPicMsgByGroupNickName(String groupnickName, String filePath) {
		String toUserName = WechatTools.getGroupNameByGroupNickName(groupnickName);
		if (toUserName != null) {
